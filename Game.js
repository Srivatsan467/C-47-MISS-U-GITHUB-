...
function createBuilding1(){
  ...
  b1 = [floor1,floor2,floor3,floor4,floor5,floor6,floor7,floor8];
}
...
function check(){
  for(var i = 0;i < b1.length;i++){
    if(b1[i].infection === true){
      floorInfection += 1;
      console.log(floorInfection);
    }
  }
  if(floorInfection === b1.length){
    text("BUILDING is infected!!!",400,300);
  }
}